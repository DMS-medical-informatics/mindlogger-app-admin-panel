...
class AddObjectForm extends Component {
  ...
  render() {
    const {handleSubmit, submitting, pristine, onLibrary} = this.props;
    return (
      ...
      <div className="wizard">
        ...
        <div className="wizard-footer">
          ...
          { onLibrary && <Button variant="contained" color="primary" disabled={submitting} onClick={onLibrary}>Choose from Library</Button>}
        </div>
      </div>
      </form>
    )
